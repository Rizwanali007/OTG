        ...
        <ScrollView>
            <View style={{ flex: 1, paddingHorizontal: 20, backgroundColor: '#FFFFFF', marginTop: 10, }}>
                ...
                <View>
                    ...
                    // onPress={() => {
                    //     navigation.navigate(screenNames.ProfileEditScreen)
                    // }}
                    >
                    ...
                    <View style={{ width: '100%' }}>
                        ...
                        <ScrollView>
                            ...
                            >
                                ...
                                <Image style={{ marginTop: 0, height: 130, width: '100%', resizeMode: "stretch", marginRight: 30, borderRadius: 15, }} source={require('../../assets/Images/image1.webp')}
                                />
                            ...
                            >
                                ...
                                <Image style={{ marginTop: 0, height: 130, width: '100%', resizeMode: "stretch", marginRight: 30, borderRadius: 15, }} source={require('../../assets/Images/image.webp')}
                                />
                                {/* <View><Text style={{ textAlign: 'center', padding: 5, fontSize: 20, color: 'black', marginTop: 80, }} >Khunjrab Pass</Text>
</View> */}
                            </TouchableOpacity>
                            ...
                            // }} 
                            >
                                <Image style={{ marginTop: 0, height: 130, width: '100%', resizeMode: "stretch", marginRight: 30, borderRadius: 15, }} source={require('../../assets/Images/image3.jpg')} />
                            ...
                            // }} 
                            >
                                <Image style={{ marginTop: 0, height: 130, width: '100%', resizeMode: "stretch", marginRight: 30, borderRadius: 15, }} source={require('../../assets/Images/image6.jpeg')} />
                                {/* <Text style={{ textAlign: 'center', padding: 5, fontSize: 20, color: 'black', }} >Abbotabad</Text>  */}
                            </TouchableOpacity>
